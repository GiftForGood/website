...
const SharePostModal = ({ postId, postUrl, postType, onClose }) => {
  const twitterShareHref = `https://twitter.com/intent/tweet?text=Check%20out%20this%20${postType}%20from%20GiftForGood!%20${postUrl}`;
  const facebookShareHref = `https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fgiftforgood.io%2F${postType}%2F${postId}%2F&amp;`;
